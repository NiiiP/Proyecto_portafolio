 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://LoginWS/", wsdlLocation = "http://localhost:8080/WebServices/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://LoginWS/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WebServices/NewWebService?wsdl");
    ...
    public Login getLoginPort() {
        return super.getPort(new QName("http://LoginWS/", "LoginPort"), Login.class);
    }
    ...
    public Login getLoginPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://LoginWS/", "LoginPort"), Login.class, features);
    }
